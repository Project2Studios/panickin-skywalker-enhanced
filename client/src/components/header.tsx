...
export default function Header() {
  ...
  const mobileMenuFeedback = useTouchFeedback({
  ...
  // Touch feedback for social icons
  const socialIconFeedback = useTouchFeedback({
  ...
  return (
    ...
    >
      <nav className="container mx-auto px-4 py-4 flex items-center justify-between">
        ...
        {/* Desktop Navigation - Cart and Social Icons */}
        <div className="hidden md:flex items-center space-x-4">
          <a
            href="#"
            className="text-muted-foreground hover:text-primary transition-colors mobile-social-icon touch-target"
          ...
          <div className="ml-4 pl-4 border-l border-border">
            <MiniCart variant="sheet" />
          </div>
        </div>

        {/* Mobile Menu Button */}
        <button
          ref={mobileMenuFeedback.ref}
          className="md:hidden text-foreground mobile-menu-button touch-ripple-container relative"
          style={mobileMenuFeedback.styles}
          onClick={() => setIsOpen(!isOpen)}
          data-testid="mobile-menu-button"
        >
          {mobileMenuFeedback.ripples}
          <motion.div
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="md:hidden bg-background border-t border-border mobile-modal safe-area-header"
            style={{
              touchAction: 'pan-y',
          ...
          >
            ...
            <div className="container mx-auto px-4 py-6">
              <ul className="space-y-2 text-center font-semibold tracking-widest">
                <li>
                  <button
                    onClick={() => scrollToSection("home")}
                    className="mobile-button-enhanced w-full py-4 rounded-lg hover:text-primary hover:bg-primary/10 transition-all mobile-text-enhanced touch-target"
