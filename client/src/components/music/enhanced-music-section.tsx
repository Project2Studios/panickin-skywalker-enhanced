...
const featuredAlbums: Album[] = [
  {
    ...
    totalTracks: 12,
    totalDuration: '42:15',
    spotifyUrl: 'https://open.spotify.com/album/example-inner-space',
    youtubeUrl: 'https://youtube.com/playlist?list=example-inner-space',
    appleMusicUrl: 'https://music.apple.com/album/example-inner-space',
    bandcampUrl: 'https://panickinskywalker.bandcamp.com/album/inner-space',
    isNew: true,
    isFeatured: true,
